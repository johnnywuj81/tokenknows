/**
 * ReviewPage handleViewEvidence callback · 通过 ChapterBlock 真实点击 [N] 触发.
 */
...
function withReview(ui: ReactNode) {
...
describe('ReviewPage handleViewEvidence', () => {
  beforeEach(() => {
    vi.restoreAllMocks()
