...
export const fixtureAssets: Asset[] = [
  ...
  // ── v0.2 书籍类长文档 ────────────────────────────────────────
  {
    id: 'asset-book-handbook-v1',
    project_id: PROJECT_ID,
    type: 'book',
    title: 'TokenKnows 内部技术手册 v1',
    status: 'approved',
    current_version: 1,
    template_id: 'tpl-book-handbook',
    created_by: CREATOR,
    approval_state: 'approved',
    redaction_state: 'all_confirmed',
    metrics: { coverage: 0.93, citation_density: 0.81, slop_score: 0.07, similarity: 0.21 },
    created_at: isoOffset(12, 9, 0),
    updated_at: isoOffset(4, 16, 30),
  },
  {
    id: 'asset-book-engineering-handoff',
    project_id: PROJECT_ID,
    type: 'book',
    title: '工程交接书 · v0.3 IM 集成全卷',
    status: 'generating',
    current_version: 1,
    template_id: 'tpl-book-handoff',
    created_by: CREATOR,
    approval_state: 'pending',
    redaction_state: 'any_unresolved',
    metrics: { coverage: 0.62, citation_density: 0.55, slop_score: 0.18, similarity: 0.42 },
    created_at: isoOffset(0, 11, 0),
    updated_at: isoOffset(0, 11, 30),
  },
]
